...
class SignInActivity : AppCompatActivity(), GoogleApiClient.OnConnectionFailedListener {
    ...
    private fun initClickListeners() {
        btn_to_signup?.setOnClickListener { v -> startActivity(Intent(this@SignInActivity, SignUpActivity::class.java)) }

        btn_reset_password?.setOnClickListener { v -> startActivity(Intent(this, ResetPasswordActivity::class.java)) }

        sign_in_phone_number_button?.setOnClickListener { v ->
